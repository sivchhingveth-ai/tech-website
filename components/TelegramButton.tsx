          ...
          <div className="p-4 bg-nexus-dark">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-3.5 py-3 bg-nexus-accent text-nexus-dark rounded-xl text-sm font-semibold hover:bg-nexus-accentGlow transition-all"
              >
