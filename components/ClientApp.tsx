        ...
        <div className="min-h-screen bg-nexus-black text-gray-100 font-sans selection:bg-nexus-accent selection:text-nexus-dark flex flex-col">
            ...
            <footer className="bg-nexus-dark border-t border-nexus-border mt-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
                    {/* Top Section */}
                    <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-6 sm:gap-x-6 sm:gap-y-10 mb-6 sm:mb-10">
                        {/* Brand */}
                        <div className="col-span-3 md:col-span-4 lg:col-span-2">
                            <h3 className="text-white font-bold text-base sm:text-xl mb-2 sm:mb-3">KEYCRAFT STUDIO</h3>
                            <p className="text-gray-500 text-xs sm:text-sm mb-3 sm:mb-4 max-w-xs">Premium keyboards, mice, and gaming accessories.</p>
                            <div className="flex gap-2 sm:gap-3">
                                <a href="https://t.me/Chhingzi" target="_blank" rel="noopener noreferrer" className="animate-social-pulse w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-nexus-card border border-nexus-border flex items-center justify-center text-gray-400 hover:text-white hover:border-nexus-accent transition-all">
                                ...
                                <a href="#" className="animate-social-pulse w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-nexus-card border border-nexus-border flex items-center justify-center text-gray-400 hover:text-white hover:border-nexus-accent transition-all">
                        ...
                        {/* Shop */}
                        <div>
                            <h4 className="text-white font-semibold text-xs sm:text-sm mb-2 sm:mb-4">Shop</h4>
                            <ul className="space-y-1 sm:space-y-2.5">
                                <li><a href="/keyboard" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Keyboards</a></li>
                                <li><a href="/mouse" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Mice</a></li>
                                <li><a href="/keycap" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Keycaps</a></li>
                                <li><a href="/accessory" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Accessories</a></li>
                            </ul>
                        </div>

                        {/* Support */}
                        <div>
                            <h4 className="text-white font-semibold text-xs sm:text-sm mb-2 sm:mb-4">Support</h4>
                            <ul className="space-y-1 sm:space-y-2.5">
                                <li><a href="/help-center" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Help Center</a></li>
                                <li><a href="/shipping-info" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Shipping Info</a></li>
                                <li><a href="/returns" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Returns & Refunds</a></li>
                                <li><a href="/warranty" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Warranty</a></li>
                                <li><a href="/contact" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Contact Us</a></li>
                            </ul>
                        </div>

                        {/* Company */}
                        <div>
                            <h4 className="text-white font-semibold text-xs sm:text-sm mb-2 sm:mb-4">Company</h4>
                            <ul className="space-y-1 sm:space-y-2.5">
                                <li><a href="/about" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">About Us</a></li>
                                <li><a href="/careers" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Careers</a></li>
                                <li><a href="/blog" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Blog</a></li>
                                <li><a href="/privacy" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Privacy Policy</a></li>
                                <li><a href="/terms" className="text-gray-500 text-xs sm:text-sm hover:text-nexus-accent transition-colors">Terms of Service</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    {/* Bottom Bar */}
                    <div className="border-t border-nexus-border pt-4 sm:pt-6 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
                        <p className="text-gray-600 text-[10px] sm:text-xs">&copy; 2026 KeyCraft Studio Inc. All rights reserved.</p>
                        <div className="flex items-center gap-3 sm:gap-4 text-[10px] sm:text-xs text-gray-600">
                            <span>We Accept:</span>
                            <div className="flex items-center gap-1.5 sm:gap-2">
                                <span className="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-nexus-card rounded border border-nexus-border text-[9px] sm:text-[10px] font-medium text-gray-400">ABA Pay</span>
                                <span className="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-nexus-card rounded border border-nexus-border text-[9px] sm:text-[10px] font-medium text-gray-400">ACLEDA</span>
                                <span className="px-1.5 py-0.5 sm:px-2 sm:py-1 bg-nexus-card rounded border border-nexus-border text-[9px] sm:text-[10px] font-medium text-gray-400">COD</span>
                            </div>
                        </div>
                    </div>
                </div>
