            ...
            <div>
              ...
              {paymentMethod === 'cod' && (
                <div className="bg-nexus-dark rounded-xl p-6 border border-nexus-border animate-fade-in">
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 rounded-xl bg-nexus-accent px-6 py-3 text-sm font-bold text-nexus-dark transition-all duration-300 hover:bg-nexus-accentGlow hover:scale-[1.02] active:scale-[0.98] mt-4"
                  >
