        ...
        >
            ...
            <div className="grid gap-6 md:grid-cols-3 mb-16">
                ...
                <a
                    ...
                    className="bg-nexus-card border border-nexus-accent/40 rounded-2xl p-6 hover:border-nexus-accent transition-colors flex flex-col"
                >
                ...
                <a
                    ...
                    className="bg-nexus-card border border-nexus-border rounded-2xl p-6 hover:border-nexus-accent/20 transition-colors flex flex-col"
                >
                    <div className="w-11 h-11 rounded-xl bg-nexus-accent/10 flex items-center justify-center mb-4">
                ...
                {/* Visit us */}
                <div className="bg-nexus-card border border-nexus-border rounded-2xl p-6 hover:border-nexus-accent/20 transition-colors flex flex-col">
                    <div className="w-11 h-11 rounded-xl bg-nexus-accent/10 flex items-center justify-center mb-4">
                        <svg className="w-6 h-6 text-nexus-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            {/* Support hours */}
            <div className="mb-16 bg-nexus-card border border-nexus-border rounded-2xl p-6 hover:border-nexus-accent/20 transition-colors">
                <div className="flex items-center gap-3 mb-5">
                    ...
                    <h2 className="text-white font-bold text-xl">Support hours</h2>
                </div>
            ...
            <div className="mb-16">
                <h2 className="text-white font-bold text-xl mb-2">What can we help with?</h2>
                <p className="text-gray-500 text-sm mb-6">Jump straight to the answer you need.</p>
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {helpLinks.map(link => (
                        <Link
                            key={link.title}
                            href={link.href}
                            className="bg-nexus-card border border-nexus-border rounded-2xl p-6 hover:border-nexus-accent/20 transition-colors group"
                        >
            ...
            <div className="mb-16">
                ...
                {submitted ? (
                    <div className="bg-nexus-card border border-nexus-accent/40 rounded-2xl p-8 text-center">
            ...
            <div className="bg-nexus-card border border-nexus-border rounded-2xl p-8 text-center">
                <h3 className="text-white text-xl font-bold mb-2">Prefer to chat right now?</h3>
                <p className="text-gray-400 mb-6">Our team is on Telegram for instant help with orders and product questions.</p>
                <a
                    href="https://t.me/Chhingzi"
                    target="_blank"
                    rel="noopener noreferrer"
