                    ...
                    <div className="flex animate-marquee whitespace-nowrap">
                        {[...Array(2)].map((_, i) => (
                            <div key={i} className="flex gap-4 mr-4">
                                <a href="https://t.me/Chhingzi" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-nexus-card border border-nexus-border text-white px-5 py-2.5 rounded-xl font-bold hover:border-nexus-accent/40 transition-all duration-300 hover:scale-105 text-sm whitespace-nowrap">
